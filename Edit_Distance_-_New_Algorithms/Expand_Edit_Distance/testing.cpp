...
bool testingEditDistance (int **matrixToTest, char const *text, char const *pattern, int whatRow)
{
   ...
   for (i = 1; i < text_len + 1; i++)
       for (j = 1; j < pattern_len + 1; j++)
       {
           if (matrix[i][j] != matrixToTest[i + whatRow][j])
           {
               ...
               printf ("   ");
               for (i = 0; i < pattern_len + 1; i++)
                  printf ("%3d", matrixToTest[0 + whatRow][i]);
               printf ("\n");
               ...
               for (i = 0; i < text_len; i++)
               {
                  printf ("%3c", text[i]);
                  for (j = 0; j < pattern_len + 1; j++)
                     printf ("%3d", matrixToTest[i + 1 + whatRow][j]);
                  printf ("\n");
               }
