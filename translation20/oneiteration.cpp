...
void OneIteration(char* str, long length, int ** matrix_forward, int ** matrix_reverse,
                  ...
                  struct LastReportedRepeat right, long int offset, FILE* outfile)
{
   ...
   for (j = MIN_PERIOD; j <= n - 1 + length%2; j++)
   {
    for (direction = 0 ; direction < 2 ; direction++)
    {
        ...
        else if (direction == 0)
        {
            ...
            // FILLS UP MATRIX_FORWARD & MATRIX_REVERSE (moved here by Miriam Briskman, 04.13.2020)
            buildmatrixforward (matrix_forward, mid_forward, mid_forward_len, 
                                left_forward, left_forward_len, j);
            buildmatrixbackward (matrix_reverse, mid_backward, mid_backward_len, 
            ...
            // FILLS UP MATRIX_FORWARD & MATRIX_REVERSE (moved here by Miriam Briskman, 04.13.2020)
            buildmatrixforward (matrix_forward, right_forward, right_forward_len, 
                                mid_forward, mid_forward_len, j);
            buildmatrixbackward (matrix_reverse, right_backward, right_backward_len, 
