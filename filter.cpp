...
bool matchpoint (const rep*, const rep*, long*, long*);
bool repcomp (rep, rep);
...
// 'matchpoint'
// Input: r1, r2 (rep struct pointers), pos1, pos2 (long int pointers).
// Output: matching results: 1 or 0 (bool).
// Procedure:
//   Tell if two repeats match based on the condition described in the comment
//   inside the function. Update positions accordingly.
// Author: Justin, Tojeira, 04.29.2009
bool matchpoint (const rep *r1, const rep *r2, long *pos1, long *pos2)
{
...
// 'repcomp'
// Input: r1, r2 (rep struct pointers).
// Output: comparison results: 1 or 0 (bool).
// Procedure:
//   Tell how two repeats compare based on their
//   boudary points.
// Author: Justin, Tojeira, 04.29.2009
