...
void tracealign (int**, char*, char*, int, int, long&, long&, bool&, FILE*); // Miriam Briskman, 02.20.2020
void traceforward (int**, char*, char*, int, int, long, long, bool, FILE*, long); // Miriam Briskman, 02.20.2020
