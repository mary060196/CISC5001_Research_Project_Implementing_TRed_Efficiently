...
void tracealign (int** m, char* s1, char* s2, int s1pos, int s2pos, 
                 long &pos1, long &pos2, bool &state, FILE* outfile)
{

/************************* VARIABLE INITIALIZATION ****************************/
   // row and col refer to the computer representation of the KxK matrix.
   // oPos is used to keep position on output1 and output2.
   int row = s2pos - s1pos + max_errors,
       col = max_errors - ((row>max_errors)?row-max_errors:max_errors-row),
       oPos = 0;
...
/*************************** MAIN TRACEBACK LOOP ******************************/
   ...
   while (s1pos >= 0 && s2pos >= 0)
   {
      ...
      {        
          ...
          pos1++;                        // up move in computer's KxK
          state = 1;
      }
      ...
      {      
          ...
          pos2++;                    // down move in computer's KxK
          state = 1;
      }
      ...
      {                                  // in the case of the characters we're up
      ...
      { // if none of the above cases are true, there is an error in the traceback,
        // probably due to inconsistent passed parameters
          printf("\n\n          *!*!*!*!*!*!*!*!* ERROR *!*!*!*!*!*!*!*!*!*\n\n");
...
void traceforward (int** m, char* s1, char* s2, int s1pos, int s2pos, 
                   long pos1, long pos2, bool state, FILE* outfile, long size)
{
...
/************************* VARIABLE INITIALIZATION ****************************/
   ...
   int row = s2pos - s1pos + max_errors,
       ...
       oPos = 0,
       length; // Miriam Briskman, 02.23.2020
...
/*************************** MAIN TRACEBACK LOOP ******************************/
   ...
   while (s1pos >= 0 && s2pos >= 0)
   {
      ...
      {                                  
          ...
          s1pos--;                       // to in S1 and S2 matching, we make a
          s2pos--;                       // diagonal move in the virtual NxN and
                                         // no move in either representation of the
      }                                  // KxK
      else
      {
          printf("\n\n          *!*!*!*!*!*!*!*!* ERROR *!*!*!*!*!*!*!*!*!*\n\n");
          ...
          printf("          *!*!*!*!*!*!*!*!* ERROR *!*!*!*!*!*!*!*!*!*\n\n");
                        ...
                        // there is an error in the traceback,
                        // probably due to inconsistent
...
/************************ FINISHES UP THE TRACEBACK ***************************/
   ...
   while (length >= 0)
   {
       if (forward_pattern2[length] == '-')
       {
           pos2++;
           state = 1;
       }
       else if (forward_pattern1[length] == '-')
       {
           pos1++;
           state = 1;
       }
